# Victor AR  
### Cherche un stage de 3e dans la cybersécurité
...
### Scolarité
**[Depuis 2023] Collège.** Actuellement en 3e, avec anglais et espagnol (commence en 6e).

### Projets
**[2025-2026] Création d’un jeu en Python.** Dans le cadre d’un atelier périscolaire.  
...
### Informatique
- **Suite Office.** Bonne maîtrise de Word, PowerPoint et OneDrive (je prends mes cours sur iPad ou ordi).  
- **Internet.** Utilisation courante d’Internet et des mails   
- **Python.** Débutant et apprentissage en cours  
- **AI.** Bidouillage avec ChatGPT pour réviser les cours  

### Langues
- **Anglais.** Très bon niveau (cours depuis le CE1 - 2020)  
- **Espagnol.** Bon niveau (cours depuis la 6e - 2023)  

### Centres d’intérêt
- **Jeux vidéo.** Sur Switch et PS5
    - Delta Force (grade Marechal)
    - Call of Duty
    - Valorant 
    - CyberPunk 2077
    - Eldering
